        ...
        var anchor:Vec2;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(18,61.5)   ,  Vec2.weak(21.5,56)   ,  Vec2.weak(21.5,16)   ,  Vec2.weak(16,10.5)   ,  Vec2.weak(15,10.5)   ,  Vec2.weak(10.5,16)   ,  Vec2.weak(10.5,56)   ,  Vec2.weak(14,61.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
