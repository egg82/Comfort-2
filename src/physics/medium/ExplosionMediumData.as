...
public class ExplosionMediumData {
        ...
        var anchor:Vec2;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(31.5,162)   ,  Vec2.weak(70,186.5)   ,  Vec2.weak(70,137.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(295.5,162)   ,  Vec2.weak(255,134.5)   ,  Vec2.weak(255.5,188)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(257,66.5)   ,  Vec2.weak(207,77.5)   ,  Vec2.weak(247.5,114)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(71.5,69)   ,  Vec2.weak(81.5,117)   ,  Vec2.weak(126,77.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(161,293.5)   ,  Vec2.weak(195,247.5)   ,  Vec2.weak(135,253.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(259,256.5)   ,  Vec2.weak(249.5,197)   ,  Vec2.weak(211,246.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(70,137.5)   ,  Vec2.weak(70,186.5)   ,  Vec2.weak(79.5,198)   ,  Vec2.weak(80.5,127)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(211,246.5)   ,  Vec2.weak(249.5,197)   ,  Vec2.weak(195,247.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(195,247.5)   ,  Vec2.weak(249.5,197)   ,  Vec2.weak(255.5,188)   ,  Vec2.weak(133,72.5)   ,  Vec2.weak(126,77.5)   ,  Vec2.weak(127,246.5)   ,  Vec2.weak(135,253.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(164.5,33)   ,  Vec2.weak(160,30.5)   ,  Vec2.weak(133,72.5)   ,  Vec2.weak(164.5,34)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(247.5,114)   ,  Vec2.weak(207,77.5)   ,  Vec2.weak(194.5,76)   ,  Vec2.weak(133,72.5)   ,  Vec2.weak(248.5,126)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(164.5,34)   ,  Vec2.weak(133,72.5)   ,  Vec2.weak(186.5,69)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(186.5,69)   ,  Vec2.weak(133,72.5)   ,  Vec2.weak(194.5,76)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(255,134.5)   ,  Vec2.weak(248.5,126)   ,  Vec2.weak(133,72.5)   ,  Vec2.weak(255.5,188)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(81.5,117)   ,  Vec2.weak(80.5,127)   ,  Vec2.weak(79.5,198)   ,  Vec2.weak(115,245.5)   ,  Vec2.weak(127,246.5)   ,  Vec2.weak(126,77.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(69.5,254)   ,  Vec2.weak(73,255.5)   ,  Vec2.weak(115,245.5)   ,  Vec2.weak(79.5,198)   ],
                            mat,
                            filt
                        );
                        s.body = body;
            ...
            anchor = (true) ? body.localCOM.copy() : Vec2.get(0,327);
            body.translateShapes(Vec2.weak(-anchor.x,-anchor.y));
            body.position.setxy(0,0);

            bodies["MASK_Explosion"] = new BodyPair(body,anchor);
