        ...
        var anchor:Vec2;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(20,61)   ,  Vec2.weak(20,60)   ,  Vec2.weak(14,61)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(13,61)   ,  Vec2.weak(14,61)   ,  Vec2.weak(20,60)   ,  Vec2.weak(21,58)   ,  Vec2.weak(13,60)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(13,12)   ,  Vec2.weak(13,13)   ,  Vec2.weak(19,12)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(20,12)   ,  Vec2.weak(19,12)   ,  Vec2.weak(13,13)   ,  Vec2.weak(12,15)   ,  Vec2.weak(20,13)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(21,60)   ,  Vec2.weak(21,58)   ,  Vec2.weak(20,60)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(12,60)   ,  Vec2.weak(13,60)   ,  Vec2.weak(21,58)   ,  Vec2.weak(22,15)   ,  Vec2.weak(12,15)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(12,13)   ,  Vec2.weak(12,15)   ,  Vec2.weak(13,13)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(21,13)   ,  Vec2.weak(20,13)   ,  Vec2.weak(12,15)   ,  Vec2.weak(21,15)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(19,62)   ,  Vec2.weak(19,61)   ,  Vec2.weak(14,61)   ,  Vec2.weak(14,62)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(14,11)   ,  Vec2.weak(14,12)   ,  Vec2.weak(19,12)   ,  Vec2.weak(19,11)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(22,58)   ,  Vec2.weak(22,15)   ,  Vec2.weak(21,58)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(11,58)   ,  Vec2.weak(12,58)   ,  Vec2.weak(12,15)   ,  Vec2.weak(11,15)   ],
                            mat,
                            filt
                        );
                        s.body = body;
            ...
            bodies["HORDE_Sentry_Bullet"] = new BodyPair(body,anchor);
