        ...
        var anchor:Vec2;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(15,61.5)   ,  Vec2.weak(21.5,57)   ,  Vec2.weak(21.5,17)   ,  Vec2.weak(16,10.5)   ,  Vec2.weak(15,10.5)   ,  Vec2.weak(10.5,15)   ,  Vec2.weak(10.5,55)   ],
                            mat,
                            filt
                        );
                        s.body = body;
