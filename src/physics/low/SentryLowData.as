        ...
        var anchor:Vec2;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(113.5,59)   ,  Vec2.weak(110,44.5)   ,  Vec2.weak(81.5,33)   ,  Vec2.weak(70,50.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(81.5,33)   ,  Vec2.weak(64,14.5)   ,  Vec2.weak(63,14.5)   ,  Vec2.weak(46,33.5)   ,  Vec2.weak(70,50.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(18,44.5)   ,  Vec2.weak(14.5,59)   ,  Vec2.weak(70,50.5)   ,  Vec2.weak(46,33.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
