package objects {
	...
	public class ReliefStar extends BaseObject implements IPrototype {
		//vars
		...
		//constructor
		public function ReliefStar(gameType:String) {
			...
			graphicsComponent = new GraphicsComponent(gameType, "star_relief", 0.6, 0, 3);
		...
		public function clone():IPrototype {
			var c:ReliefStar = new ReliefStar(gameType);
			c.create();
			return c;
		}
