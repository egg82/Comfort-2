package objects {
	...
	public class StressBall extends BaseObject implements IPrototype {
		//vars
		...
		//constructor
		public function StressBall(gameType:String) {
			...
			graphicsComponent = new GraphicsComponent(gameType, "ball_standard", 0.6, 0, 0);
			
			physicsComponent.setShapes([new Circle(15)]);
		...
		public function clone():IPrototype {
			var c:StressBall = new StressBall(gameType);
			c.create();
			return c;
		}
