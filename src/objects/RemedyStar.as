package objects {
	...
	public class RemedyStar extends BaseObject implements IPrototype {
		//vars
		...
		public function RemedyStar(gameType:String) {
			...
			graphicsComponent = new GraphicsComponent(gameType, "star_remedy", 0.6, 0, 3);
		...
		public function clone():IPrototype {
			var c:RemedyStar = new RemedyStar(gameType);
			c.create();
			return c;
		}
